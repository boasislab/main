(function(){
  ...
  var enrichmentKey='forest_oak_study_wrong_enrichment_20260915_v3';
  ...
  var topicLinks={
    '응급처치':{'심장발작 위험요인과 응급 대응':'20260313_응급처치_정리본.html','심폐소생술의 원리와 시행 기준':'20260313_응급처치_정리본.html','응급처치 목적과 기본 절차':'20260313_응급처치_정리본.html'},
    '야외활동지도':{'자연선호 이론과 야외활동 효과':'20260317_야외활동지도_정리본.html#forest-comfort-theories','야외활동 효과와 안전':'20260317_야외활동지도_정리본.html'},
    '생명의숲 밧줄놀이':{'밧줄 설치 수목 선정과 안전':'20260404_생명의숲밧줄놀이_정리본.html#knots'},
    '커뮤니케이션':{'의사소통·경청·피드백':'20260711_커뮤니케이션_정리본.html#listening','대상별 눈높이 커뮤니케이션':'20260711_커뮤니케이션_정리본.html#target','도입과 관계 형성':'20260711_커뮤니케이션_정리본.html#process'},
  ...
  Object.keys(grouped).forEach(function(subject){
    ...
    var item={id:id,subject:(subject==='숲해설기법'?'커뮤니케이션':subject)+' 심화',topic:cleanTopics.join(' · '),source:noteLinks[subject]||'team_oak_activity.html',links:cleanTopics.map(function(label){return {label:label,href:(topicLinks[subject]&&topicLinks[subject][label])||noteLinks[subject]||'team_oak_activity.html'};}),done:old?!!old.done:false,createdAt:old&&old.createdAt||new Date().toISOString()};
